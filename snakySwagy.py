...
batch = 32
epochs=10
NB_NEURONES=6 #S'il n'y a qu'une seule couche le deuxième chiffre n'est pas pris en compte
...
"FONCTION RENVOYANT LES RECOMPENSES"
...
"VERSION UN JOUEUR"
# Return false to quit program, true to go to gameover
